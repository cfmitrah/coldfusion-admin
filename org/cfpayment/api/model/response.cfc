...
--->
	...
	<cfscript>
		...
		variables.cfpayment.ProcessorStatus = "";
	...
	<cffunction name="getProcessorStatus" output="false" access="public" returntype="any" hint="">
		<cfreturn variables.cfpayment.ProcessorStatus />
	</cffunction>

	<cffunction name="setProcessorStatus" output="false" access="public" returntype="any" hint="">
		<cfset variables.cfpayment.ProcessorStatus = arguments[1] />
		<cfreturn this />
	</cffunction>
