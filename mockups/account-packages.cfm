...
<div id="page">
	<div id="sidebar">
		...
		<div class="side-section">
			...
			<ul>
				<li><a href="account-packages.cfm" class="active">Overview</a></li>
			</ul>
		</div>
		<div class="side-section">
	...
	<div id="main-content-wrapper" class="has-sidebar">
		<div id="main-content">
			...
			<h2 class="page-title color-03">Account Package</h2>
			<p class="page-subtitle">View the package related to your account below</p>
