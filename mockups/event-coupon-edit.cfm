...
<div id="page">
	...
	<div id="main-content-wrapper" class="has-sidebar">
		<div id="main-content">
			...
			<h2 class="page-title color-02">Manage Discount</h2>
			<p class="page-subtitle">Edit the details for this specific discount below</p>
			<form action="" class="basic-wrap mt-medium">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="form-group col-md-6 col-md-offset-3">
							<input type="submit" class="btn btn-success btn-block btn-lg" value="Save Discount Settings">
						</div>
					</div>
				</div>
			</form>
