...
<div id="page">
	<div id="sidebar">
		...
		<div class="side-section">
			...
			<ul>
				<li><a href="account-billing.cfm" class="active">Overview</a></li>
			</ul>
		</div>
	</div>
	...
	<div id="main-content-wrapper" class="has-sidebar">
		<div id="main-content">
			...
			<h2 class="page-title color-04">Billing</h2>
			<p class="page-subtitle">Manage your billing information below</p>
