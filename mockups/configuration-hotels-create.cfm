...
<div id="page">
	...
	<div id="main-content-wrapper" class="has-sidebar">
		<div id="main-content">
			...
			<h2 class="page-title color-06">Create a New Hotel</h2>
			<p class="page-subtitle">You can add locations to a hotel once the hotel has been created. First fill in the information below.</p>
			
			<form action="" role="form" class="basic-wrap mt-medium">
				<div class="container-fluid">
					<h3 class="form-section-title">Hotel Details</h3>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-12">
							<button type="submit" class="btn btn-success btn-lg"><strong>Create Hotel</strong></button>
						</div>
					</div>
				</div>
