...
component accessors="true" extends="app.model.base.Dao" {
	...
	*/
	public struct function EmailDefaultsGet(
		...
		sp.addParam( type="out", dbvarname="@has_from_email", cfsqltype="cf_sql_bit", value=arguments.has_from_email, null=( !len( arguments.has_from_email ) ), variable="has_from_email" );
		...
		sp.addParam( type="out", dbvarname="@has_subject", cfsqltype="cf_sql_bit", value=arguments.has_subject, null=( !len( arguments.has_subject ) ), variable="has_subject" );
		...
		sp.addParam( type="out", dbvarname="@has_header", cfsqltype="cf_sql_bit", value=arguments.has_header, null=( !len( arguments.has_header ) ), variable="has_header" );
		...
		sp.addParam( type="out", dbvarname="@header_thumbnail", cfsqltype="cf_sql_varchar", value=arguments.header_thumbnail, maxlength=200, null=( !len( arguments.header_thumbnail ) ), variable="header_thumbnail" );
		result = sp.execute();
