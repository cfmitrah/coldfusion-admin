            	...
            	<tr>
                	<td align="center" valign="top">
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
                            <Cfif structkeyexists( local, 'header_filename' ) &&  len( local.header_filename )>
	                        	<tr>
	                            	<td align="center" valign="top">
                                                        ...
                                                        <td valign="top" width="350">
                                                            <div>
																<cfif structKeyExists( local,"footer") and len( local.footer )>
		                                                        	#local.footer#
		                                                        <!---<em>&copy; #year(now())# IGATE, Privacy Policy | <a href="http://www.igate.com">www.igate.com</a>.</em>--->
		                                                        <cfelse>
