<cfoutput>
 <ul class="nav nav-tabs mt-medium" role="tablist">
	<cfloop from="1" to="#rc.agenda_manage.count#" index="local.idx">
		...
		<li class="#local.active_class[ local.idx eq 1 ]#"><a href="##day-#local.idx#" role="tab" data-toggle="tab">#local.tab_name# (#local.session_count#)</a></li>
	</cfloop>
</ul>
<div class="tab-content" id="session_wrapper">
	<cfloop from="1" to="#rc.agenda_manage.count#" index="local.idx">
		<cfset local.agenda_categories = rc.agenda_manage.data[ local.idx ] />
		<cfset local.total_fees = local.agenda_categories.total_fees />
        ...
        <div class="tab-pane #local.active_class[ local.idx eq 1 ]#" id="day-#local.idx#">
