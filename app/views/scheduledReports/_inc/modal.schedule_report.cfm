...
<div class="modal fade" id="schedule-modal" >
	<div class="modal-dialog" style="position:relative;">
		<div class="whiteout" style="height:500px;width:600px;background:##fff;opacity:.5; position:absolute;border-radius:5px;z-index:99;"></div>
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Save and Schedule for Later</h4>
			</div>
			<form method="post" action="#buildURL( 'scheduledReports.doSaveSchedule' )#" class="form-horizontal validate-frm"  data-parsley-validate data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden">
			<input type="hidden" id="report_schedule_id" name="report.report_schedule_id" value="" />
			...
			<div class="modal-body">
				<h3 id="report-name" class="form-section-title">Settings</h3>
			...
			<div class="modal-footer">
				...
				<button id="save_schedule" type="submit" class="btn btn-success">Save and Schedule</button>
			</div>
		</form>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
